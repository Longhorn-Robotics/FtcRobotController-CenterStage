...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double WHEEL_RADIUS = 1.34; // in
    ...
    public static double X_MULTIPLIER = 0.523255813953; // Multiplier in the X direction
    public static double Y_MULTIPLIER = 0.522243713733; // Multiplier in the Y direction
    ...
    public StandardTrackingWheelLocalizer(HardwareMap hardwareMap, List<Integer> lastTrackingEncPositions, List<Integer> lastTrackingEncVels) {
        ...
        leftEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "motorFL")); // port 0
        rightEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "motorBL")); // port 1
        frontEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "motorBR")); // port 2
